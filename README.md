...
Make sure you have Python Flask installed. For Python3, use:
...
Send a GET request or open a browser to http://localhost:5000/status to check if the API is running
